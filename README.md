...
| PART 2 실시간 병상 | 완료 | NEMC 534개 유지, API 응답 442개·유효 포화율 423개 |
...
| PART 3 최종 regionRisk | 부분 완료 | 219개 중 202개 산출 완료, 17개 원천데이터부족 |
| PART 4 상관관계·VIF | 완료 | 최종 점수가 완성된 지역 대상 |
| PART 4 선형회귀 | 완료 | 완료지역 202개 전체, R² -0.406, MAE 5.15 |
| PART 4 K-Means | 완료 | 202개 지역, 최적 k=2 |
| 최신 시군구 경계 | 완료 | `admdongkor` `20260701`, 256개 경계 |
| PART 4 과거 시간대 분석 | 미완료 | 2024년 병상 이력 원자료 필요 |

최종 위험도가 없는 17개 지역은 임의 점수로 대체하지 않고 `원천데이터부족`으로 표시합니다.
...
|---|---:|---|---:|
| 0 | 123 | 도시형·인구 대비 병상 부담형 | 24.79 |
| 1 | 79 | 접근성·의료진 취약형 | 42.25 |
